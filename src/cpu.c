...
chip8_op_t op_handlers[35] = {
	...
	{ .opcode = 0xF018, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "LD" },
	{ .opcode = 0xF01E, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "ADD" },
	{ .opcode = 0xF029, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "LD" },
	{ .opcode = 0xF033, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "LD" },
	{ .opcode = 0xF055, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "LD" },
	{ .opcode = 0xF065, .opmask = 0xF0FF, .handler = chip8_op_todo, .name = "LD" },
};
